...
class ComponentToPrint extends React.Component {
  ...
  render() {
    ...
    const date = new Date(item.ordered);
        ...
        >
          <div style={{ display: "flex" }}>
            ...
            >
              ...
              >
                {item?.store_info?.display_name.substring(0, 30)}
              </h3>
              <p
                className="m-0 shop-address"
                style={{ color: "#000000", maxWidth: "300px" }}
              >
                {item.store_info && item?.store_info?.address.area}
              </p>
              <p
          ...
          >
            <div>
              ...
              <p className="line-0">Delivery: {item.delivery_type}</p>
            </div>
            <div>
              <p className="line-0">Date: {dt + "/" + month + "/" + year}</p>
              <p className="line-0">payment: {item.payment_type}</p>
            </div>
          </div>
          <div>
            <Row
