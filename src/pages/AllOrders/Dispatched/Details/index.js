...
import ContactCustomer from "../../../../components/ContactCustomerModal";
import ConformationAssociate from "../../../../components/ConformationAssociate";
...
export default function Details(props) {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch((error) => {
        setIsAssign(error?.response.data.success);
        setAssignLoading(false);
      });
  ...
  const startShipping = () => {
    axios
      .patch("/order/shipTheOrder", {
        order_id: item._id,
        shop_id: storeId,
        category_id: categoryId,
      })
      .then((response) => {
        setShippingStart(response.data.data);
